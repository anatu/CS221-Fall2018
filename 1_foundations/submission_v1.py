...
def mutateSentences(sentence):
    ...
    # TODO: Fix issue with only finding the first matching bigram to chain on
    # i.e. needs to find ALL matching chains. Change compute-mutations to operate on
    # multiple candidate chains instead of one (e.g. "the cat" starter should give
    # "the cat and the cat" AND "the cat and the mouse")
